...
$(document).ready(function()
{
    ...
    {
        $.post('backend.php', {show_register: true}, function(data)
        {
    ...
    $('#login-submit').live('click', function()
    {
        ...
        $.post('backend.php', {try_login: true, login_email: _email, login_password: _password}, function(data)
        {
            if (data != "LOGIN = GOOD;")
            {
                alert(data);
    ...
    $('#register-submit').live('click', function()
    {
        ...
        $.post('backend.php', {try_register: true, register_email: _email, register_password: _password}, function(data)
        {
    ...
    $('#character-submit').live('click', function()
    {
        ...
        $.post('backend.php', {create_character: true, creation_username: _username}, function(data)
        {
    ...
    if (window.location.href.indexOf("characters") == 17)
    {
        $.post('backend.php', {load_characters: true}, function(data)
        {
            /*
            newHeight = 230;
...
{
    $.post('backend.php', {activate_character:true, activation_id: _id}, function(data)
    {
