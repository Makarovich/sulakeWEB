...
class Template
{
    ...
    public function addTemplate($templateFile)
    {
        ...
        ################################################
        //Add it into the tplCache
        $this->_templateCache[$templateFile] = $this->grabTemplate(APPLICATION.LIBRARY.VIEWS.HTML.$templateFile);
    ...
    public function templateLoaded($templateName)
    {
        return array_key_exists(($templateName), $this->_templateCache);
    }

    private function emptyFilter($requestedTemplate)
    {
        return preg_replace('/${([^}]+)}/', null, $requestedTemplate);
    }
    ...
    public function publishHTML()
    {
        ...
        $this->setParameter('content', $this->parseParameters($this->_templateContent));
        $this->setParameter('end', $this->parseParameters($this->_endContent));
        ...
        echo $this->emptyFilter($this->parseParameters($this->_templateBody));
    }
    ...
    private function onCreate()
    {
        ...
        $this->_templateBody = $this->grabTemplate(APPLICATION.LIBRARY.VIEWS.HTML.'dimension-one.html');
    }
}
